  ...
  return(
    ...
    <nav className='flex h-12 items-center justify-between px-4 bg-white'>
      ...
      <div className='flex gap-2'>
        <img src="whatsapp.png" className='w-9 h-7 border px-2 py-1 rounded-lg  flex-1 flex-grow-0' onClick={whatsapp} />       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
